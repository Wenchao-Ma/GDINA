...
Ma, W. & de la Torre, J. (2020). GDINA: The generalized DINA model framework. R package version 2.8.0. Retrived from [https://CRAN.R-project.org/package=GDINA](https://CRAN.R-project.org/package=GDINA)
