...
#' diagnostic tree model (Ma, 2018) can also be estimated using \code{\link{DTM}} function for polytomous responses. Note that these functions are experimental, and are expected to be further extended
#' in the future.
#'
